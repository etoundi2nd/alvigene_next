          ...
          <div className="container sans-serif">
            <div className="mb-2">
              <p>
                ...
                Nous sommes fiers de produire uniquement des produits de soins
                de la peau et de beauté à partir de composants biologiques et
                cultivés localement.
              </p>
              <br />
              <p>
