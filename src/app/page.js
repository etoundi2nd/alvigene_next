						...
						<div className="content">
							<h1 className="index-hero--title">
								<span className="text-bg-hero">
									Donnez à votre peau <br /> <em>des soins</em> nécessaires <br />& mérités.
								</span>
							</h1>
							<div className="index-hero--description">
								<span className="text-bg-hero">
									Symbole universel du naturel, de la pureté et de l'uniformité du tint,
									<strong className="text-dark-green bg-citrus-green px-0-5">
										les savons Alvigène doux et hydratants à la bave pure d'escargot
									</strong>
				...
				<div className="index-hero-banner">
					<div className="container index-hero-banner--content">
						<div className="index-hero-banner--infos">
							{services.map((s) => (
								<Service key={s.path_icon} path_icon={s.path_icon} title={s.title} description={s.description} />
							))}
						</div>
					</div>
				</div>
				...
				<div id="products" className="index-products">
					<div className="container">
						<div className="index-products--content">
							...
							<div className="description">Explorez nos savons solide et liquide à la bave pure d'escargot.</div>
						</div>
						<div className="products-list pt-2 pb-4">{<ProductList />}</div>
						<div className="products-list pt-2 pb-4">{/* Begin Products list type gel */}</div>
					</div>
				</div>
					...
					<div className="container">
						<div className="index-our-qualities--content">
							<div className="detail">
								...
								<div className="content">
									Un mélange unique d'ingrédients organiques harmonise et protège votre peau contre les maladies, vergetures, rides,
							...
							<div className="detail">
								...
								<div className="content">
									Nous élevons nos escargots dans le respect et l'hygiène nécessaires pour obtenir de la salive pure non infecté.
								</div>
							</div>
							<div className="detail">
								<div className="dot bg-red"></div>
								<div className="content">
									Nous sommes fondamentalement contre l'éclaircissage de la peau. Nos produits sont faits pour protéger votre peau et votre
									teint naturel.
								</div>
							</div>
							<div className="detail">
								<div className="dot bg-yellow"></div>
								<div className="content">Tous nos ingrédients sont produits au Cameroun.</div>
							</div>
						</div>
					</div>
				</div>
					...
					<div className="container text-center">
						...
						<div className="index-our-customers--content">
							<div className="navigation">
								<button type="button" className="btn" data-action="showNext" data-change-by="-1">
